...
namespace Server.Items
{
    ...
    public class RegionControl : Item
    {
        ...
        public string RegionName
        {
            ...
            set
            {
                if (Map != null && !RegionNameTaken(value))
                    ...
                    Console.WriteLine(
                        "RegionName not changed for {0}, {1} already has a Region with the name of {2}",
                        this,
                        Map,
                        value
                    );
        ...
        public RegionControl(Rectangle2D rect) : base(5609)
        {
            ...
            DoChooseArea(null, this.Map, newrect.Start, newrect.End);
        ...
        public RegionControl(Rectangle3D rect) : base(5609)
        {
            ...
            DoChooseArea(null, this.Map, rect.Start, rect.End);
